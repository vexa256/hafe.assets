	...
	function tp_settings_append($x) {
		...
		<div class="tp-theme-wrapper">
		   ...
		   <div class="tp-theme-settings">
             ...
             <button class="tp-theme-color-btn tp-color-settings-btn d-none" data-color-default="#175D24" type="button" data-color="#175D24"></button>
						  <button class="tp-theme-color-btn tp-color-settings-btn" type="button" data-color="#175D24"></button>
					   </div>
					</div>
					<div class="col">
					   <div class="tp-theme-color-item tp-color-active">
